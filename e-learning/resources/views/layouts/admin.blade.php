                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="{{route('all-students')}}" class="nav-link">All Students</a>
                                </li>                               
                                <li class="nav-item">
                                    <a href="{{route('add-student')}}" class="nav-link">Add Student</a>
                                </li>
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu">
                                <li class="nav-item">
                                    <a href="{{route('all-teachers')}}" class="nav-link">All Teachers</a>
                                </li>
                                
                                <li class="nav-item">
                                    <a href="{{route('add-teacher')}}" class="nav-link"></i>Add Teacher</a>
                                </li>
