                ...
                <table class="table display data-table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><img class="img-circle" src={{asset('img/students/'.$sinhVien->hinh_anh.'')}} alt="student"></td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href={{route('delete-student', ['username'=>$sinhVien->username])}}><i
                                                class="fas fa-times text-orange-red"></i>Delete</a>
                                        <a class="dropdown-item" href={{route('student-detail', ['username'=>$sinhVien->username])}}><i
