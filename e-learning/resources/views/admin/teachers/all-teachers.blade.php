                            ...
                            @foreach ($dsTeacher as $teacher)
                                <tr>
                                    ...
                                    <td class="text-center"><img class="img-circle"
                                            src={{ asset('img/users/' . $teacher->hinh_anh . '') }} alt="teacher"></td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a onclick="return confirm('Are you sure?')" class="dropdown-item"
                                                    href={{ route('delete-account', ['username' => $teacher->username]) }}><i
                                                        class="fas fa-times text-orange-red"></i>Delete</a>
                                                <a class="dropdown-item"
                                                    href={{ route('admin-teacher-detail', ['username' => $teacher->username]) }}><i
