...
Route::middleware('student')->prefix('student')->group(function () {
    ...
    Route::get('/delete-join-classroom/{ma_lop}', [StudentController::class, 'deleteJoinClass'])->name('delete-join-class');
     //Add Comment
     Route::post('binhluan/{ma_lop}/{id_bai_dang}', [CommentController::class, 'postComment'])->name('classroom-student-comment_POST');
});
...
Route::middleware('teacher')->prefix('teacher')->group(function () {
    ...
    //Add Comment
    Route::post('binhluan/{ma_lop}/{id_bai_dang}', [CommentController::class, 'postComment'])->name('classroom-teacher-comment_POST');
});
