                            ...
                            @endphp
                                @foreach ($dsClassroom as $classroom)
                                    <tr>
                                        ...
                                        <td class="banner" class="text-center"><img
                                                src={{ asset('img/classrooms/' . $classroom->banner . '') }}
                                                alt="student"></td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a onclick="return confirm('Are you sure?')" class="dropdown-item"
                                                        href={{ route('detete-classroom', ['ma_lop' => $classroom->ma_lop]) }}><i
                                                            class="fas fa-times text-orange-red"></i>Delete</a>
                                                    <a class="dropdown-item"
                                                        href={{ route('classroom-detail', ['ma_lop' => $classroom->ma_lop]) }}><i
                                                            class="fas fa-cogs text-dark-pastel-green"></i>Detail</a>
                                                    <a class="dropdown-item" href="#"><i
                                                            class="far fa-edit text-orange-peel"></i>Edit</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
