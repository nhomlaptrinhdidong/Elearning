                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" onclick="return confirm('Are you sure?')"
                                                    href={{ route('delete-account', ['username' => $sinhVien->username]) }}><i
                                                        class="fas fa-times text-orange-red"></i>Delete</a>
                                                <a class="dropdown-item"
                                                    href={{ route('admin-student-detail', ['username' => $sinhVien->username]) }}>
                                                    <i class="fas fa-cogs text-dark-pastel-green"></i>Detail</a>
