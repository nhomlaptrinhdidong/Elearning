    ...
    <div class="login-page-wrap">
        <div class="login-page-content">
            <div class="login-box">
                ...
                <form action="{{route('handle-reset-password')}}" class="login-form" method="POST">
                    @csrf
                    <input type="hidden" name="email" value={{$req->email}}>
                    <input type="hidden" name="token" value={{$req->code}}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" placeholder="Enter Confirm Password" name="password" class="form-control">
                        <i class="fas fa-lock"></i>
                    </div>
                    <div class="form-group">
